...
@Slf4j
public class StartAnalyser implements BeanPostProcessor, ApplicationListener<ContextRefreshedEvent> {
	...
	public Object postProcessAfterInitialization(@NotNull Object bean, @NotNull String beanName) throws BeansException {
		...
		if (Objects.nonNull(beanStartTime.get(beanName))) {
			beanStartTime.put(
					beanName,
					DateUtil.between(new DateTime(begin), new DateTime(System.currentTimeMillis()), DateUnit.MS));
		}
