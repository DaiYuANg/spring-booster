/* (C)2023*/
package org.toolkit.spring.boot.vertx.web.verticle;
...
import org.toolkit.spring.boot.vertx.web.configuration.HttpConfigurationProperties;
...
public class RootHttpVerticle extends AbstractVerticle {
	...
	public void start() {
		...
		server.listen(httpConfigurationProperties.getPort())
				.onSuccess(event -> log.atInfo().log(
						"vertx http server listen:http://localhost:{}}", httpConfigurationProperties.getPort()))
