...
public class Dir {
    ...
    public List<TreeNode<Path>> listFiles(Path rootPath) {
        ...
        for (Path path : listFile()) {
            ...
            TreeNode<Path> pathTreeNode = new TreeNode<>(path.normalize(), path.getParent(), path.toString(), (Comparable<Path>) o -> o.compareTo(o.getParent()));
...
//                .map(path -> new TreeNode<>(path.normalize(), path.getParent(), path.toString(), (Comparable<Path>) o -> o.compareTo(o.getParent())))
//                .toList();
