...
import org.toolkit4J.framework.spring.starter.event.configurations.EventConfigurationProperties;
import org.toolkit4J.framework.spring.starter.event.constant.Default;
...
public class BusPublisher {
    ...
    public void init() {
        ...
        val subscribers = context.getBeansWithAnnotation(EventBusSubscriber.class)
