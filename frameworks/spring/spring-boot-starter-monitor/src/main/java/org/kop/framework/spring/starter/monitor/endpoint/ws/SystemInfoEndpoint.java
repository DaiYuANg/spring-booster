package org.kop.framework.spring.starter.monitor.endpoint.ws;
...
import org.kop.framework.spring.starter.monitor.endpoint.services.ISystemInfoService;
...
//        System.out.println("垃圾收集器：" + gcNames);
    ...
    public void onMessage(String message) {
        asyncWorker.supply(() -> new HashMap<String, Object>() {{
                    put("now", DateUtil.date().toString());
                    put("list", systemInfoService.getAllThreadOfCurrentJVM());
                }})
                .thenApply(r -> gson.toJson(r, new TypeToken<Map<String, Object>>() {
                }.getType()))
