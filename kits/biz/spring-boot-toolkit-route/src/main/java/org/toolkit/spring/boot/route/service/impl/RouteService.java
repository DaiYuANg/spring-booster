...
public class RouteService implements IRouteService {
    ...
    @PostConstruct
    public void init() {
        val entity = new RouteEntity().setUrl("/test")
                .setParentId(String.valueOf(0))
                .setTitle("测试")
                .setExternal(false);
        routeEntityRepository.save(entity);
        val two = new RouteEntity().setParentId(entity.getId())
                .setTitle("ces11").setUrl("test/aaa");
        val three = new RouteEntity().setParentId(entity.getId())
                .setTitle("ces12").setUrl("test/bbb");
