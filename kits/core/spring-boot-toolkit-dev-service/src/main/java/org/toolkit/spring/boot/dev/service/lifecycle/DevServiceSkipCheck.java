...
class DevServiceSkipCheck {
	...
	static {
		val skipped = new LinkedHashSet<String>() {
			{
				add("org.junit.runners.");
				add("org.junit.platform.");
				add("org.springframework.boot.test.");
				add(SpringApplicationAotProcessor.class.getName());
