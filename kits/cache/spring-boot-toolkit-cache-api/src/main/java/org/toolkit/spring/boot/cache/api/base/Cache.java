...
public interface Cache<K, V> extends Stream<Cache<K, V>> {
    ...
    @Nullable V compute(@NotNull @NonNull K key,
    ...
    @Nullable V computeIfAbsent(@NotNull @NonNull K key,
                                @NotNull @NonNull Function<? super K, ? extends V> mappingFunction);
    ...
    @Nullable V computeIfPresent(@NotNull @NonNull K key,
