...
public class ReusableRequestFilter implements Filter {
    ...
    @Override
    public void doFilter(@NotNull ServletRequest servletRequest, ServletResponse servletResponse, @NotNull FilterChain filterChain) throws IOException, ServletException {
