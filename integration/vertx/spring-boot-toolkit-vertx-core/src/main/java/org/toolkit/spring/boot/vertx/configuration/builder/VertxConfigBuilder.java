...
public class VertxConfigBuilder {
	...
	public VertxOptions vertxOptions() {
		...
		Optional.ofNullable(vertxConfigurationProperties.getEventLoopPoolSize())
				.ifPresent(option::setEventLoopPoolSize);
		Optional.ofNullable(vertxConfigurationProperties.getQuorumSize()).ifPresent(option::setQuorumSize);
		Optional.ofNullable(vertxConfigurationProperties.getInternalBlockingPoolSize())
				.ifPresent(option::setInternalBlockingPoolSize);
